...
public class ListofExtensionsSipPage extends BaseTest {
	public  ListofExtensionsSipPage(WebDriver driver) {
		this.driver=driver;
	...
	public String followme_extension() throws InterruptedException {
		...
		enable5.selectByVisibleText("158-123");
	...
	public String edit_follow_extension() throws InterruptedException {
		...
		Thread.sleep(3000);
		//Select enable5=new Select(Destinationlist);
		//enable5.selectByVisibleText("125-123");
		Followmeupdate.click();
