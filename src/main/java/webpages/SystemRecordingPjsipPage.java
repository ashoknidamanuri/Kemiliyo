...
public class SystemRecordingPjsipPage extends BaseTest{
	public  SystemRecordingPjsipPage(WebDriver driver) {
		this.driver=driver;
	...
	@FindBy(xpath = "//td[@class='ng-binding'][contains(.,'surya')]")
	WebElement Delete;
	...
	WebElement Playlist;
	@FindBy(xpath = "(//i[contains(@class,'fa fa-play')])[2]")
	WebElement Playaudio;
	@FindBy(xpath = "//h4[@class='modal-title'][contains(.,'Recording Play')]")
	WebElement Pause;
	//@FindBy(xpath = "(//i[@class='fa fa-play'])[2]")
	@FindBy(xpath = "(//i[@class='fa fa-play'])[2]")
	WebElement Downloadclose;
	@FindBy(xpath = "//h4[@class='modal-title'][contains(.,'Recording Play')]")
	WebElement Playlogo;
	@FindBy(xpath = "//h4[contains(.,'Recording Play')]")
	WebElement Stop;
	...
	public String play_audio() throws InterruptedException {
		Thread.sleep(5000);
		Playaudio.click();
		Thread.sleep(1500);
		Stop.click();
