...
public class ListofExtensionsPage extends BaseTest  {
	public  ListofExtensionsPage(WebDriver driver) {
		this.driver=driver;
	...
	public String extension_validation() throws InterruptedException {
		managepbx.click();
		selectcutomer.sendKeys("pjsipus");
		Thread.sleep(1000);
	...
	public String followme_extension() throws InterruptedException {
		...
		enable4.selectByVisibleText("Ring Group");
		Thread.sleep(3000);
		Select enable5=new Select(Destinationlist);
		enable5.selectByVisibleText("SURE");
	...
	public String edit_follow_extension() throws InterruptedException {
		...
		Thread.sleep(3000);
		Select enable5=new Select(Destinationlist);
		enable5.selectByVisibleText("38-6666");
		Followmeupdate.click();
