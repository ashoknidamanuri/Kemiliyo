...
public class RingGroupsPage extends BaseTest{
	public  RingGroupsPage(WebDriver driver) {
		this.driver=driver;
	...
	public String add_ringgroup() throws InterruptedException {
		...
		announce.selectByVisibleText("System");
		...
		destinationvalue.selectByVisibleText("168");
		submit.click();
