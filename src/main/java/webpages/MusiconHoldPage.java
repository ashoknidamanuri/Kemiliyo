...
public class MusiconHoldPage  extends BaseTest {
	public  MusiconHoldPage(WebDriver driver) {
		this.driver=driver;
	...
	WebElement Success;
	@FindBy(xpath = "//td[contains(.,'someexample')]")
	...
	@FindBy(xpath = "//td[contains(.,'newmusic')]")
	WebElement Delete;
	...
	public String add_musichold() throws InterruptedException {
		...
		Action.click();
		Addmusic.click();
		Namefield.sendKeys("someexample");
